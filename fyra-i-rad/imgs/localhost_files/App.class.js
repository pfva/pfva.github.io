  ...
  renderStart() {
    ...
    super.render(`
      <div class="card-body" id="test-instructions">
        ...
        <p class="card-text">Under övningen beskrivs 24 påståenden eller situationer ställda som motpoler. Du ska ställning till vilket påstående som stämmer bäst med hur du är och känner, och i hur stor utsträckning det är så, genom att dra reglaget till någon punkt på skalan.</p>
  ...
  renderScore() {
    ...
    let html = `
      <div class="card-body" id="test-result">
        ...
        <div class="row">
          <div class="col-6">
            <p class="card-text float-left pb-3"><a href="#">Läs mer om de olika personlighetstyperna här</a></p>
          </div> 
          <div class="col-6">
